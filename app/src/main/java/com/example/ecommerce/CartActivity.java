    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Toast.makeText( CartActivity.this, "Total Price = " + String.valueOf(overToatalPrice), Toast.LENGTH_SHORT ).show();
            }
        });
    }
    @Override
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                overToatalPrice = overToatalPrice + onetimeProductTotalPrice;
                txtTotalAmount.setText("Total Price = Rs. " + String.valueOf(overToatalPrice));
